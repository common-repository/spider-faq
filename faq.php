...
add_filter('tw_get_block_editor_assets', 'sp_faq_register_block_editor_assets');
add_filter('tw_get_plugin_blocks', 'sp_faq_register_plugin_block');
add_action( 'enqueue_block_editor_assets','sp_faq_enqueue_block_editor_assets' );

function sp_faq_register_block_editor_assets($assets) {
  $plugin_url = plugins_url(plugin_basename(dirname(__FILE__)));
  $version = '2.0.5';
  $js_path = $plugin_url . '/js/tw-gb/block.js';
  $css_path = $plugin_url . '/css/tw-gb/block.css';
...
function sp_faq_register_plugin_block($blocks) {
  $plugin_name = 'Spider FAQ';
  $plugin_url = plugins_url(plugin_basename(dirname(__FILE__)));
  $icon_url = $plugin_url . '/images/spider-faq_edit_but.png';
  $icon_svg = $plugin_url . '/images/spider-faq_edit_but.png';
  $data = array('shortcodeUrl' => add_query_arg(array('action' => 'spiderFaqselectfaq'), admin_url('admin-ajax.php')));
  $blocks['tw/faq'] = array(
    'title' => $plugin_name,
    'titleSelect' => sprintf(__('Select %s', 'faq'), $plugin_name),
    'iconUrl' => $icon_url,
    'iconSvg' => array('width' => 20, 'height' => 20, 'src' => $icon_svg),
    'isPopup' => true,
    'containerClass' => 'tw-container-wrap-380-215',
    'data' => $data,
  );
  return $blocks;
}

function sp_faq_enqueue_block_editor_assets() {
  ...
  wp_localize_script('tw-gb-block', 'tw_obj_translate', array(
    'nothing_selected' => __('Nothing selected.', 'faq'),
    'empty_item' => __('- Select -', 'faq'),
